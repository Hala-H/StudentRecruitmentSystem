                        ...
                        <div class="card-body">
                          ...
                          <div class="outer-container">
                            <form action="ImportUsingExcelActivities.php" method="post" name="excelImportExcel" id="excelImportExcel" enctype="multipart/form-data">
                                <div>
                                  <label>Choose Excel File</label> <input type="file" name="file" id="file" accept=".xls,.xlsx" class="btn btn-light btn-icon-split">
                  ...
                  <div class="card shadow mb-4">
                    ...
                    <form role="form" action="addActivity.php" method = "post">
                      <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="acStuNum" class="col-sm-2 text-right control-label col-form-label">Student Number</label>
                            <div class="col-sm-2">
